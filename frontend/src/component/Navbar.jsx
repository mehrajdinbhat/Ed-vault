...
const [ authuser,setAuthUser]=useAuth();
  ...
  return (
    <>
      <div 
        className={`max-w-screen-2xl container max-auto md:px-20 px-4 fixed top-0 left-0 z-50 right-0${
        sticky? "sticky-navbar shadow-md bg-base-200 duration-300 transiton-all ease-in-out"
        :""
        }`}
      >
        <div className="navbar ">
          ...
          <div className="navbar-end space-x-3">
            <div className="navbar-center hidden lg:flex">
              <ul className="menu menu-horizontal px-2">{navItems}
